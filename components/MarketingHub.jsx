      ...
      <div style={{
        ...
        <input
          ...
          style={{
            ...
            color: "#ede8df", fontSize: 14, fontFamily: "var(--bf)", outline: "none",
            boxSizing: "border-box", transition: "border-color .2s",
          }}
        />

        {error && (
          <div style={{ fontSize: 11, color: "#e07b6a", marginBottom: 8 }}>Incorrect password — try again.</div>
        )}

        <button onClick={attempt} style={{
          width: "100%", padding: "11px", borderRadius: 9, border: "none",
          background: "linear-gradient(135deg, #c9a84c, #a07030)",
          color: "#07070f", fontFamily: "'DM Sans', sans-serif",
